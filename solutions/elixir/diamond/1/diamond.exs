defmodule Diamond do
  ...
  defp make_diamond_row({codepoint, side_padding, 0}) do
    sides  = String.duplicate(" ", side_padding)
    letter = to_string([codepoint])

    sides <> letter <> sides
  end

  defp make_diamond_row({codepoint, side_padding, middle_padding}) do 
    sides  = String.duplicate(" ", side_padding)
    middle = String.duplicate(" ", middle_padding)
    letter = to_string([codepoint])
