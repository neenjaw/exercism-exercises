...
CARD_VALUES: Final[dict[str, int]] = {
    'K': 10, 'Q': 10, 'J': 10, '10': 10, '9': 9, '8': 8, '7': 7, 
...
def value_of_ace(card_one: str, card_two: str) -> int:
    ...
    has_ace_in_hand = card_one == 'A' or card_two == 'A'

    if hand_sum + HIGH_ACE_VALUE > BUST_THRESHOLD or has_ace_in_hand:
...
def is_blackjack(card_one: str, card_two: str) -> bool:
    ...
    has_ace_in_hand = 'A' in cards
    has_ten_in_hand = any(value_of_card(card) == 10 for card in cards)

    return has_ace_in_hand and has_ten_in_hand
